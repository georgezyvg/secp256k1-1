...
console.print("\n[yellow]💰-----------------💰 HUNT4ETH RANGE DIVISION 100% VERSION Random_MIZ_ETH 💰----------------------💰[/yellow]")
...
console.print("[yellow]💰-------💰 Divide the Chosen Range by 100% and Random Scan 💰-----------💰[/yellow]")
...
while True:
    ...
    HEX100 = "%064x" % ran100
    seed100 = str(ran100)
    addr100 = ice.privatekey_to_ETH_address(int(seed100))
