...
Good Luck and Happy Hunting HASH160_Fibonacci.py Version 1 Range division by 1%-1000000% and scan Fibonacci's sequence 
...
nterms = int(input("How many nterms gap in first jump? "))
